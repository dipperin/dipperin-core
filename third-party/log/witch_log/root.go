...
func InitWitchLogger(logLevel log.Lvl, nodeName string, removeOld bool) {
	targetDir := filepath.Join(homeDir(), "tmp", "cs_debug", "witch")
	...
	log.Debug("write witch debug log to file", "path", logFilePath)
