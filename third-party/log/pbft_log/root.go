...
func init() {
	...
	root.SetHandler(log.LvlFilterHandler(log.LvlDebug, StdoutHandler))
}
...
func InitPbftLogger(logLevel log.Lvl, nodeName string, removeOld bool) {
	targetDir := filepath.Join(homeDir(), "tmp", "cs_debug", "pbft")
