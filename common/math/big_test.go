...
func TestMarshalText(t *testing.T) {
	var i *HexOrDecimal256
	_, err := i.MarshalText()
	assert.Nil(t, err)

	i = (*HexOrDecimal256)(big.NewInt(123))
	_, err = i.MarshalText()
	assert.Nil(t, err)

	bigEndianByteAt(big.NewInt(123), 1)
	bigEndianByteAt(big.NewInt(123), 100)

	Byte(big.NewInt(123), 1, 1)
	Byte(big.NewInt(123), 2, 1)
}
