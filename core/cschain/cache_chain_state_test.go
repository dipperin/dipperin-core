...
// var testFee = economymodel.GetMinimumTxFee(50)
//
...
// 	cs, err := NewCacheChainState(chainstate.NewChainState(&chainstate.ChainStateConfig{ChainConfig: chainconfig.GetChainConfig(), WriterFactory: chainwriter.NewChainWriterFactory()}))
