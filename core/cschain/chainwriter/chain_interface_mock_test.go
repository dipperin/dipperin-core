...
// Source: github.com/dipperin/dipperin-core/core/cschain/chainwriter/middleware (interfaces: ChainInterface)

// Package chainwriter is a generated GoMock package.
package chainwriter
...
import (
	...
	chainconfig "github.com/dipperin/dipperin-core/core/chainconfig"
	economymodel "github.com/dipperin/dipperin-core/core/economymodel"
...
func (m *MockChainInterface) AccountStateDB(arg0 common.Hash) (*stateprocessor.AccountStateDB, error) {
	m.ctrl.T.Helper()
...
func (m *MockChainInterface) BuildStateProcessor(arg0 common.Hash) (*stateprocessor.AccountStateDB, error) {
	m.ctrl.T.Helper()
...
func (m *MockChainInterface) CurrentState() (*stateprocessor.AccountStateDB, error) {
	m.ctrl.T.Helper()
...
func (m *MockChainInterface) GetBloomLog(arg0 common.Hash, arg1 uint64) model.Bloom {
	m.ctrl.T.Helper()
...
func (m *MockChainInterface) GetChainConfig() *chainconfig.ChainConfig {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetChainConfig")
	ret0, _ := ret[0].(*chainconfig.ChainConfig)
	return ret0
}
...
func (m *MockChainInterface) GetEconomyModel() economymodel.EconomyModel {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEconomyModel")
	ret0, _ := ret[0].(economymodel.EconomyModel)
	return ret0
}
...
func (m *MockChainInterface) GetReceipts(arg0 common.Hash, arg1 uint64) model.Receipts {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetReceipts", arg0, arg1)
	ret0, _ := ret[0].(model.Receipts)
	return ret0
}
...
func (m *MockChainInterface) GetStateStorage() stateprocessor.StateStorage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStateStorage")
	ret0, _ := ret[0].(stateprocessor.StateStorage)
	return ret0
}
...
func (m *MockChainInterface) StateAtByBlockNumber(arg0 uint64) (*stateprocessor.AccountStateDB, error) {
	m.ctrl.T.Helper()
...
func (m *MockChainInterface) StateAtByStateRoot(arg0 common.Hash) (*stateprocessor.AccountStateDB, error) {
	m.ctrl.T.Helper()
