...
func TestDeriveShaByHash_DeriveSha(t *testing.T) {
	...
	tryTx1 := NewTransaction(uint64(1), bobAddr, big.NewInt(1000), TestGasPrice, TestGasLimit, []byte{})
	...
	tryTx2 := NewTransaction(uint64(1000), bobAddr, big.NewInt(10000), TestGasPrice, TestGasLimit, []byte{})
