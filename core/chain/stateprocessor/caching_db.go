...
func (db *cachingDB) OpenTrie(root common.Hash) (StateTrie, error) {
	db.mu.Lock()
	defer db.mu.Unlock()
...
func (db *cachingDB) OpenStorageTrie(addrHash, root common.Hash) (StateTrie, error) {
	return trie.NewSecure(root, db.db, 0)
}

// CopyTrie returns an independent copy of the given trie.
func (db *cachingDB) CopyTrie(t StateTrie) StateTrie {
	switch t := t.(type) {
	case cachedTrie:
...
func (db *cachingDB) DiskDB() ethdb.Database {
	return db.db.DiskDB()
}
