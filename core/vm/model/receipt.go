...
func NewReceipt(root []byte, failed bool, cumulativeGasUsed uint64, logs []*Log) *Receipt {
	r := &Receipt{PostState: common.CopyBytes(root), CumulativeGasUsed: cumulativeGasUsed, Logs: logs}
	if failed {
