...
func MakeHaltCheckStateHandler(needChainReader NeedChainReaderFunction, walletSigner NeedWalletSigner, economyModel economymodel.EconomyModel) *StateHandler {
	return &StateHandler{
...
func (haltCheckStateHandle *StateHandler) GenProposalConfig(voteType model.VoteMsgType) (ProposalGeneratorConfig, error) {
	...
	if err != nil {
		return ProposalGeneratorConfig{}, gerror.GenProposalConfigError
	}
