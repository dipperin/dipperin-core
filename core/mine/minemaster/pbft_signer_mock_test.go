...
// Source: github.com/dipperin/dipperin-core/core/chaincommunication (interfaces: PbftSigner)
...
func (m *MockPbftSigner) Evaluate(arg0 accountsbase.Account, arg1 []byte) ([32]byte, []byte, error) {
	m.ctrl.T.Helper()
