...
import (
	...
	minemaster "github.com/dipperin/dipperin-core/core/mine/minemaster"
...
func (m *MockMasterServer) ReceiveMsg(arg0 minemaster.WorkerId, arg1 uint64, arg2 interface{}) {
	m.ctrl.T.Helper()
...
func (m *MockMasterServer) RegisterWorker(arg0 minemaster.WorkerForMaster) {
	m.ctrl.T.Helper()
...
func (m *MockMasterServer) UnRegisterWorker(arg0 minemaster.WorkerId) {
	m.ctrl.T.Helper()
