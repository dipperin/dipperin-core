...
// the specified pool.
func (journal *txJournal) load(add func([]model.AbstractTransaction) []error) error {
	...
	var (
		failure error
		batch   []model.AbstractTransaction
	)
	for {
...
func (journal *txJournal) insert(tx model.AbstractTransaction) error {
...
func (journal *txJournal) rotate(all map[common.Address][]model.AbstractTransaction) error {
