...
// Source: github.com/dipperin/dipperin-core/core/chaincommunication (interfaces: PeerManager)
...
func (m *MockPeerManager) BestPeer() chaincommunication.PmAbstractPeer {
	m.ctrl.T.Helper()
...
func (m *MockPeerManager) GetPeer(arg0 string) chaincommunication.PmAbstractPeer {
	m.ctrl.T.Helper()
...
func (m *MockPeerManager) GetPeers() map[string]chaincommunication.PmAbstractPeer {
	m.ctrl.T.Helper()
