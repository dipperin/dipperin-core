...
// Source: github.com/dipperin/dipperin-core/core/chaincommunication (interfaces: AbstractPbftProtocolManager)

// Package rpcinterface is a generated GoMock package.
...
func (m *MockAbstractPbftProtocolManager) BestPeer() chaincommunication.PmAbstractPeer {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BestPeer")
	ret0, _ := ret[0].(chaincommunication.PmAbstractPeer)
	return ret0
}
...
func (m *MockAbstractPbftProtocolManager) GetNextVerifierPeers() map[string]chaincommunication.PmAbstractPeer {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNextVerifierPeers")
	ret0, _ := ret[0].(map[string]chaincommunication.PmAbstractPeer)
	return ret0
}
...
func (m *MockAbstractPbftProtocolManager) GetPeer(arg0 string) chaincommunication.PmAbstractPeer {
	m.ctrl.T.Helper()
...
func (m *MockAbstractPbftProtocolManager) GetPeers() map[string]chaincommunication.PmAbstractPeer {
	m.ctrl.T.Helper()
...
func (m *MockAbstractPbftProtocolManager) GetVerifierBootNode() map[string]chaincommunication.PmAbstractPeer {
	m.ctrl.T.Helper()
