...
func (api *DipperinVenusApi) EstablishWallet(password, passPhrase string, walletIdentifier accountsbase.WalletIdentifier) (mnemonic string, err error) {
...
func (api *DipperinVenusApi) OpenWallet(password string, walletIdentifier accountsbase.WalletIdentifier) error {
...
//   "200":
//        description: return operation result
func (api *DipperinVenusApi) CloseWallet(walletIdentifier accountsbase.WalletIdentifier) error {
...
//   "200":
//        description: return operation result
func (api *DipperinVenusApi) RestoreWallet(password, mnemonic, passPhrase string, walletIdentifier accountsbase.WalletIdentifier) error {
...
func (api *DipperinVenusApi) ListWallet() ([]accountsbase.WalletIdentifier, error) {
...
func (api *DipperinVenusApi) ListWalletAccount(walletIdentifier accountsbase.WalletIdentifier) ([]accountsbase.Account, error) {
...
func (api *DipperinVenusApi) AddAccount(derivationPath string, walletIdentifier accountsbase.WalletIdentifier) (accountsbase.Account, error) {
