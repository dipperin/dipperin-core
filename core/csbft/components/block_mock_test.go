...
func (m *MockAbstractBlock) GetBlockTxsBloom() *iblt.Bloom {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBlockTxsBloom")
	ret0, _ := ret[0].(*iblt.Bloom)
	return ret0
}
...
func (m *MockAbstractBlock) GetBloom() iblt.Bloom {
	m.ctrl.T.Helper()
...
func (m *MockAbstractBlock) GetEiBloomBlockData(arg0 *iblt.HybridEstimator) *model.BloomBlockData {
	m.ctrl.T.Helper()
