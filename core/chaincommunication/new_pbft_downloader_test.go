...
func TestNewPbftDownloader_onGetBlocks(t *testing.T) {
	...
	fakeBlock1 := createTestBlock(common.HexToDiff("0x1effffff"), 1)
...
func TestNewPbftDownloader_fetchBlocks(t *testing.T) {
	...
	fakeBlock2 := createTestBlock(common.HexToDiff("0x1effffff"), 1)
...
func TestNewPbftDownloader_importBlockResults(t *testing.T) {
	...
	fakeBlock := createTestBlock(common.HexToDiff("0x1effffff"), 1)
