...
func TestNewBlockFetcher(t *testing.T) {
	assert.NotNil(t, NewBlockFetcher(func() model.AbstractBlock {
		return nil
	}, func(hashes common.Hash) model.AbstractBlock {
		return nil
	}, func(block model.AbstractBlock, seenCommits []model.AbstractVerification) error {
		return nil
	}, func(b *model2.VerifyResult) {
...
func TestBlockFetcher_DoTask(t *testing.T) {
	...
	block := createTestBlockByNumber(3)
